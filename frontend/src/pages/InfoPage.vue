<template>
  ...
  <div >
        <div class="row">
            <h1 class="text-center text-secondary">InfoPage</h1>
        </div>
...
export default {
    ...
    onMounted(() => {
      getUserLocation()
      this.buyerSeller = localStorage.getItem('buyerSeller')
      this.cost = localStorage.getItem('cost')
      this.predPrice = localStorage.getItem('predPrice')
      this.predPriceList = localStorage.getItem('predPriceList')
    })
    ...
    data() {
        return {
          ...
          LAT: 0,
          ZIP: 78746,
          buyerSeller : localStorage.getItem('buyerSeller'),
          cost : localStorage.getItem('cost'),
          predPrice : localStorage.getItem('predPrice'),
          predPriceList :localStorage.getItem('predPriceList'),
        };
    },
    methods: {        
        submitForm() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    console.log(predictedPrice['PredictedPrice'] ,predictedPrice['PredictedPriceList'])
